...
export default function TypingEffect() {
  ...
  return (
    <div className="flex flex-col justify-center items-center tracking-wider">
      <h1 className="text-white xs:ml-[-14px] sm:ml-[53px] md:-ml-[65px] lg:ml-[-37px]">
        <TextGenerateEffect
      ...
      <h2 className="text-white xs:ml-[-64px] sm:ml-[-23px] md:-ml-[79] lg:-ml-[115px]">
        ...
        <div className="flex justify-center items-center xs:-ml-[16px] sm:-ml-[16px] md:-ml-[30px] lg:-ml-[25px] xs:text-3xl sm:text-3xl md:text-3xl lg:text-4xl">
